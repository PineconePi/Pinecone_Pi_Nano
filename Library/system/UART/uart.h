...
extern	unsigned char	xdata TX1_Buffer[COM_TX1_Lenth];	//发送缓冲
extern	unsigned char 	xdata RX1_Buffer[COM_RX1_Lenth];	//接收缓冲
extern	unsigned char	xdata TX2_Buffer[COM_TX2_Lenth];	//发送缓冲
extern	unsigned char 	xdata RX2_Buffer[COM_RX2_Lenth];	//接收缓冲
