...
* @{
*/
#define PRODUCT_KEY "b9547704357f46c78dfb3e200c77fcf1"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "74cc1ae7258f4bd59fb622dcd65ba61a"
...
* @{
*/
#define Power_on_BYTEOFFSET                    0
#define Power_on_BITOFFSET                     0
#define Power_on_LEN                           1
#define Power_off_BYTEOFFSET                    0
#define Power_off_BITOFFSET                     1
#define Power_off_LEN                           1
#define Reset_BYTEOFFSET                    0
#define Reset_BITOFFSET                     2
#define Reset_LEN                           1

#define CPU_DATA_RATIO                         1
#define CPU_DATA_ADDITION                      0
#define CPU_DATA_MIN                           0
#define CPU_DATA_MAX                           100
#define Memory_DATA_RATIO                         0.1
#define Memory_DATA_ADDITION                      0
#define Memory_DATA_MIN                           0
#define Memory_DATA_MAX                           40
#define CPU2_DATA_RATIO                         1
#define CPU2_DATA_ADDITION                      1
#define CPU2_DATA_MIN                           0
#define CPU2_DATA_MAX                           99
#define CPU3_DATA_RATIO                         1
#define CPU3_DATA_ADDITION                      1
#define CPU3_DATA_MIN                           0
#define CPU3_DATA_MAX                           99
#define CPU4_DATA_RATIO                         1
#define CPU4_DATA_ADDITION                      1
#define CPU4_DATA_MIN                           0
#define CPU4_DATA_MAX                           99
/**@} */
...
typedef struct {
  ...
  bool valuePower_off;
  bool valueReset;
  uint32_t valueCPU_DATA;
  float valueMemory_DATA;
  uint32_t valueCPU2_DATA;
  uint32_t valueCPU3_DATA;
  uint32_t valueCPU4_DATA;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */ 
typedef struct {
  uint8_t flagPower_on:1;
  uint8_t flagPower_off:1;
  uint8_t flagReset:1;
} attrFlags_t;
...
typedef struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valueCPU_DATA;
  uint8_t valueMemory_DATA;
  uint8_t valueCPU2_DATA;
  uint8_t valueCPU3_DATA;
  uint8_t valueCPU4_DATA;
} devStatus_t; 
